...
- Ease of use: As a conference attendee in any posible role, all you need is a web browser. We recommend using Chrome or Firefox. There's no need to install any desktop or mobile software. The browser-based service offers a highly adaptive interface that meets the needs of various user roles.
...
1. Plug in your microphone and camera **before** connecting to a conference.
