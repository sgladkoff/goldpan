...
If a project has already had files assigned to it, clicking on its name in the list will take you to the project page, where each file is represented as a task. You can assign more tasks with the **Create Task** button.
